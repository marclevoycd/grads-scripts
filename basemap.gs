...
*  if (lowres); file = 'lpoly_US.asc'; endif
  if (lowres); file = 'C:/Program Files/OpenGrADS/Contents/Resources/SupportData/lpoly_lowres.asc'; endif
  if (mres)  ; file ='C:/Program Files/OpenGrADS/Contents/Resources/SupportData/lpoly_mres.asc'  ; endif
  if (hires) ; file ='C:/Program Files/OpenGrADS/Contents/Resources/SupportData/lpoly_hires.asc' ; endif
endif
if (type = 'O' | type = 'o') 
  if (lowres); file = 'C:/Program Files/OpenGrADS/Contents/Resources/SupportData/opoly_lowres.asc'; endif
  if (mres)  ; file = 'C:/Program Files/OpenGrADS/Contents/Resources/SupportData/opoly_mres.asc'  ; endif
  if (hires) ; file = 'C:/Program Files/OpenGrADS/Contents/Resources/SupportData/opoly_hires.asc' ; endif
endif
if (type = 'cnout' | type = 'CNOUT' )
   file = 'C:\Program Files\OpenGrADS\Contents\Resources\SupportData\cn_out.txt' 
  endif
